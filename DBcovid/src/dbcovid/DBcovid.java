...
public class DBcovid {
    ...
    public static void main(String[] args) throws FileNotFoundException, JSONException {
        ...
        JsonReader reader = Json.createReader(new FileReader("/Users/benjawan/Project Compo/covid.txt"));
    ...
    public static void persist(Object object) {
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("DBcovidPU");
